---
name: dk-system
description: Domain Knowledge 建立系統。當用戶說「我接了一個新專案」、「幫我做 Kickoff」、「幫我建立邏輯地圖」、「週五到了幫我更新邏輯地圖」、「幫我跑 DK」、「我剛 Kickoff 完」、「幫我維護邏輯地圖」、「解釋這段」、「評估替代方案」、「整合舊記錄」，或任何與新專案開始、邏輯地圖建立、每週維護、技術內容解釋相關的需求時，一律使用這個 skill。
---
...
## 遇到困難情境時
Michelle 說「PM 答案很模糊」、「PO 和工程師吵起來了」、「我不在時有人做了決定」等情況
→ 讀取 dk-system/references/situations.md，找到對應情境，引導 Michelle 處理

## 待開發功能（遇到時再補）
以下情境目前 skill 尚未完整支援，遇到時請告訴 Michelle 目前的限制並用手動方式引導：
- #18 多專案管理（同時讀取多個 report.md）
- #19 跨專案 bug 影響矩陣
- #25 資料 schema 驗證
...
| dk-system/references/situations.md | 遇到困難情境時 |
