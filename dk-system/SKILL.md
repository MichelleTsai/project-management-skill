...
步驟：
1. 讀取 logic_map/專案名稱_report.md（如果有相關專案）
2. 帶 Michelle 走一遍六個問題：
   - 我現在知道什麼？
   - 我還不知道什麼？
   - 這件事該問誰？
   - 最重要的一件事是什麼？
   - 最壞的情況是什麼？
   - 我的第一個動作應該是什麼？
3. 把突發資訊記進 log.md（加【專案名稱】標籤）
4. 如果影響核心假設，提醒 Michelle 是否要立刻更新 report.md
...
| dk-system/references/step3_troubleshoot.md | 模式四和模式七/八，技術解釋、往主管報告、突發資訊時 |
